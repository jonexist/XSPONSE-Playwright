...
test.describe('Customer Status Filtering', () => {
  ...
  test('should filter and display all customers with Enable status', async ({ page }) => {
    ...
    const statusBadges = page.locator('div.text-sm.font-bold.uppercase.text-success');
